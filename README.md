...
```bash
git clone https://github.com/kshitizgaero/Drone-Stabilization-Foundation-RL.git
cd Drone-Stabilization-Foundation-RL

pip install -r requirements.txt

python drone_stabilization_foundation.py


### Step 4: Save the File
1. Scroll down to the bottom
2. Under **Commit changes**:
   - **Commit message:** `Update README with complete project documentation`
3. Make sure **Commit directly to the main branch** is selected
4. Click the green **Commit changes** button

### Step 5: Refresh and Verify
1. Refresh your repository page
2. Scroll down the README
